...
function DoActionBefore($message_text){
  ...
  if ("@game" == $message_text) {
    ...
    if ("group" == $event->source->type){
      ...
      $record_text = "insert into game_room (game_room_num, game_room_id, game_mode, num_of_people, num_of_roles, num_of_votes) values (100, " . $gameRoomId . ", 'WAITING', 0, 0, 0);";
      $result = mysqli_query($link, $record_text);
