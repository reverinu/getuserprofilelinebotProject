...
function DoActionAll($message_text){
  ...
  if ("@help" == $message_text) {
    ...
    $result = mysqli_query($link, "insert into roles (role_num, role_name) values (1, '村人');");
    $result = mysqli_query($link, "insert into roles (role_num, role_name) values (2, '占い師');");
    $result = mysqli_query($link, "insert into roles (role_num, role_name) values (3, '怪盗');");
    $result = mysqli_query($link, "insert into roles (role_num, role_name) values (4, '人狼');");
    $result = mysqli_query($link, "insert into roles (role_num, role_name) values (5, '狂人');");
